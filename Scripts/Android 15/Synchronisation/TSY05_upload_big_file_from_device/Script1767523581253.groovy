...
String folderName = 'TSY05_' + timestamp_folder
...
Mobile.tap(findTestObject('CreateNewFile/SelectUploadBigFileFromDevice'), 30)
Mobile.delay(10)
...
file_obj.addProperty("xpath", ConditionType.EQUALS, "//*[contains(@text, 'debian')]")
...
String serverPath = (folderName + '/') + fileName
