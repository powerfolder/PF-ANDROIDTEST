...
CustomKeywords.'utils.Swipe_object.swipe'(text_obj)
...
top_file_obj.addProperty("xpath", ConditionType.EQUALS, "//*[@text='" + renamefile + ".txt']")
...
WebUI.callTestCase(findTestCase('Android 14Logout/Logout'), [:], FailureHandling.CONTINUE_ON_FAILURE)