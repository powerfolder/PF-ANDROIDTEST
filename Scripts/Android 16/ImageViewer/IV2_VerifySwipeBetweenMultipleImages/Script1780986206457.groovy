...
Mobile.tap(findTestObject('CreateNewFile/SelectUploadThirdFileFromDevice'), 30)
Mobile.delay(10)
...
// open uploaded image
Mobile.tap(file_obj, 5)

// Move to Screenshot1
CustomKeywords.'utils.ImageViewerSwipe.swipeToNextImage'()
...
Mobile.tap(findTestObject('ImageViewer/ImageCloseButton'),30)
Mobile.delay(5)
