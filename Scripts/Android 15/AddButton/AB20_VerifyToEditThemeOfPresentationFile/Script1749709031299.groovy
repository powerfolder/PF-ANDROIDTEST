...
// Verifying theme page
Mobile.tap(findTestObject('EditPresentationFile/Theme'),30)
Mobile.delay(3)
Mobile.verifyElementExist(findTestObject('EditPresentationFile/HeaderOfThemePopup'), 10)
Mobile.tap(findTestObject('VerifyCreatedFileNames/CloseButton'),30)
Mobile.delay(5)
