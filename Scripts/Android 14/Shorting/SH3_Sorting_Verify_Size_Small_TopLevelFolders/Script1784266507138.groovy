...
// Verify Smallest -> Largest
assert folderNames.get(0).equals(secFolderName) :
	"Smallest sorting failed. Expected first folder: ${secFolderName}, Actual: ${folderNames.get(0)}"

assert folderNames.get(1).equals(folderName) :
	"Smallest sorting failed. Expected second folder: ${folderName}, Actual: ${folderNames.get(1)}"

println("Smallest Size Sorting verified successfully.")
