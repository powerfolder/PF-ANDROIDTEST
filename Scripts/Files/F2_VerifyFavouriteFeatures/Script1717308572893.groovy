...
Mobile.delay(3)
Mobile.waitForElementPresent(findTestObject('Folder_Menu/ClickOnFolder'), 30, FailureHandling.OPTIONAL)
Mobile.delay(3)
Mobile.tap(findTestObject('Folder_Menu/ClickOnFolder'), 30,FailureHandling.CONTINUE_ON_FAILURE) 
Mobile.delay(3)
Mobile.tap(findTestObject('Folder_Menu/ClickSubFolder'),30, FailureHandling.CONTINUE_ON_FAILURE) 
Mobile.delay(3)
Mobile.tap(findTestObject('Folder_Menu/DropdownUnderFolder'), 30)
int sizeBefore=  MobileDriverFactory.getDriver().findElementsByXPath("//*[@class = 'android.widget.Image' and (@text = 'Icon' or . = 'Icon')]").size()
 
Mobile.delay(3)
Mobile.tap(findTestObject('Folder_Menu/FavouriteBtn'), 30)

int sizeAfter=  MobileDriverFactory.getDriver().findElementsByXPath("//*[@class = 'android.widget.Image' and (@text = 'Icon' or . = 'Icon')]").size()
Mobile.verifyNotEqual(sizeBefore, sizeAfter)
Mobile.delay(3) 
