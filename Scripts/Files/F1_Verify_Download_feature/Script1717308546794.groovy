...
Mobile.delay(5)
Mobile.verifyElementExist(findTestObject('Folder_Menu/DownloadBtn'), 45, FailureHandling.CONTINUE_ON_FAILURE)
Mobile.tap(findTestObject('Folder_Menu/DownloadBtn'), 30)

//String checkingFilesText = Mobile.getText(findTestObject('Folder_Menu/checkingFiles'), 20, FailureHandling.CONTINUE_ON_FAILURE)

//Mobile.verifyEqual(checkingFilesText, 'Checking files..This may take a while.', FailureHandling.CONTINUE_ON_FAILURE)
