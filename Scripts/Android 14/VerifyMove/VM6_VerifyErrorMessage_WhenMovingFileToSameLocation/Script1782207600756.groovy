...
// Swap left to right to move target folder
...
// Verify aleardy exists error alert
String alertMsg = Mobile.getText(findTestObject('SwipeMove/ValidateErrorMsg'), 30)
Mobile.verifyEqual(alertMsg, 'Already exists')
