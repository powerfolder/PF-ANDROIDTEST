...
import utils.PowerFolderAPI as PowerFolderAPI
...
String randomEmail = ('user' + System.currentTimeMillis()) + '@qa-automated-mobiletest-A16.com'
...
def folderID = api.getFolderIdByName(GlobalVariable.ApiURL + '/folders', GlobalVariable.userid, GlobalVariable.password, 
    folderName)

// get Invitations byFolderID and check if user is listed by api
def invited = api.isUserInvitedToFolder("$GlobalVariable.ApiURL/invitations", folderID, GlobalVariable.userid, GlobalVariable.password, 
    randomEmail)
