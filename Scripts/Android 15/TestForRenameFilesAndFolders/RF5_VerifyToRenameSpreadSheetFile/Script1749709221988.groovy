...
CustomKeywords.'utils.Swipe_object.swipe'(spreadsheet_obj)
...
top_file_obj.addProperty("xpath", ConditionType.EQUALS, "//*[@text='" + renamefile + ".xlsx']")
