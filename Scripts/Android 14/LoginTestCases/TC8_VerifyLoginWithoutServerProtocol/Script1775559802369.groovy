...
if (Mobile.verifyElementExist(findTestObject('LoginScreen/LoginButton'), 5, FailureHandling.OPTIONAL)) {
	CustomKeywords.'utils.Process_login.login'(GlobalVariable.ServerURLWithoutProtocol,GlobalVariable.userid, GlobalVariable.password)
}
...
obj.addProperty("xpath", ConditionType.EQUALS, "//*[@resource-id='user_name']")

String name = Mobile.getText(obj, 10)

assert name == GlobalVariable.userid

Mobile.tap(findTestObject('ThreeDotsMenu/MyAccountBackButton'), 45)
