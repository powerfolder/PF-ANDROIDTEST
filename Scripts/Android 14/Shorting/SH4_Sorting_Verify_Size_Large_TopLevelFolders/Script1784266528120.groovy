...
// Select large size sorting option
Mobile.tap(findTestObject('Object Repository/Shorting/ShortByLargeSize'), 30)

// Wait for sorting to complete
Mobile.delay(2)

// ==========================================
// Verify Largest Size Sorting
// ==========================================
...
// Verify Largest -> Smallest
assert folderNames.get(0).equals(folderName) :
    "Largest sorting failed. Expected first folder: ${folderName}, Actual: ${folderNames.get(0)}"

assert folderNames.get(1).equals(secFolderName) :
    "Largest sorting failed. Expected second folder: ${secFolderName}, Actual: ${folderNames.get(1)}"

println("Largest Size Sorting verified successfully.")
