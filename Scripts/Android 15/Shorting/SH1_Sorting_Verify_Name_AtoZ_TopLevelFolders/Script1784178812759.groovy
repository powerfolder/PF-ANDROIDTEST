...
assert folderNames.get(0).equals(folderName) :
		"A-Z sorting failed. Expected first folder: ${folderName}, Actual: ${folderNames.get(0)}"

assert folderNames.get(1).equals(secFolderName) :
		"A-Z sorting failed. Expected second folder: ${secFolderName}, Actual: ${folderNames.get(1)}"

println("A-Z Sorting verified successfully.")
