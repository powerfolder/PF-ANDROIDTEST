...
//click on edit button with help of coordinates and create duplicate slide and delete slide
Mobile.delay(20)
...
Mobile.scrollToText("DUPLICATE SLIDE")
Mobile.delay(2)
Mobile.tap(findTestObject('EditPresentationFile/DuplicateSlideButton'),30)
Mobile.tapAtPosition(GlobalVariable.PresentationEditButtontapX,GlobalVariable.PresentationEditButtontapY)
Mobile.scrollToText('DeleteSlide', FailureHandling.STOP_ON_FAILURE)
Mobile.tap(findTestObject('EditPresentationFile/DeleteSlide'),30)
Mobile.tap(findTestObject('VerifyCreatedFileNames/CloseButton'),30)
