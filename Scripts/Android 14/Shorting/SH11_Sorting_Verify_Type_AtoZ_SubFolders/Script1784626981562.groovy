...
// Select A-Z sorting
Mobile.delay(3)
Mobile.tap(findTestObject('Object Repository/Shorting/ShortByTypeAToZ'), 30)

// Wait for sorting to complete
Mobile.delay(2)

// ==========================================
// Verify A-Z File Sorting
// ==========================================
...
// Verify two files are displayed
assert fileNames.size() == 2 : "Expected 2 uploaded files, but found ${fileNames.size()}"
...
assert fileNames == expected :
		"A-Z File Sorting failed.\nExpected: ${expected}\nActual: ${fileNames}"

println("A-Z File Sorting verified successfully.")
